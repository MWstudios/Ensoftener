...
namespace Ensoftener
{
    ...
    /// <summary>A prefabricated effect inherited from <seealso cref="CustomEffectBase"/>. You can modify its input count, constant buffer and its nodes.
    /// <br/>You can even nest more effects inside it.</summary>
    [CustomEffect("A shader that inherits from PixelShaderBase", "PSB inheritors", "Ensoftener"), CustomEffectInput("Source")]
    public class PixelShaderBase : CustomEffectBase, DrawTransform
    {
        ...
        public PixelShaderBase(Guid guid) { GUID = guid; Global.ExistingEffects.Add(this); }
        ...
        {
            dInfo = drawInfo; dInfo.SetPixelShader(GUID, PixelOptions.None);
    ...
    public class CloneablePixelShader : PixelShaderBase { public CloneablePixelShader() : base(Guid.NewGuid()) { } }
}
