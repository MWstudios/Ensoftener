...
namespace Ensoftener
{
    ...
    public static class DCChaining
    {
        ...
        public static RenderTarget ChainBeginDraw(this RenderTarget d2dc) { d2dc.BeginDraw(); return d2dc; }
        public static RenderTarget ChainClear(this RenderTarget d2dc, RawColor4? clearColor) { d2dc.Clear(clearColor); return d2dc; }
        ...
        public static RenderTarget ChainDrawBitmap(this RenderTarget d2dc, Bitmap bitmap, RawRectangleF? sourceRectangle,
        ...
        public static RenderTarget ChainDrawEllipse(this RenderTarget d2dc, Ellipse ellipse, Brush brush, float strokeWidth = 1)
        { d2dc.DrawEllipse(ellipse, brush, strokeWidth); return d2dc; }
        public static RenderTarget ChainDrawEllipse(this RenderTarget d2dc, Ellipse ellipse, Brush brush, StrokeStyle strokeStyle, float strokeWidth = 1)
        { d2dc.DrawEllipse(ellipse, brush, strokeWidth, strokeStyle); return d2dc; }
        public static RenderTarget ChainDrawGeometry(this RenderTarget d2dc, Geometry geometry, Brush brush, float strokeWidth = 1)
        { d2dc.DrawGeometry(geometry, brush, strokeWidth); return d2dc; }
        public static RenderTarget ChainDrawGeometry(this RenderTarget d2dc, Geometry geometry, Brush brush, StrokeStyle strokeStyle, float strokeWidth = 1)
        { d2dc.DrawGeometry(geometry, brush, strokeWidth, strokeStyle); return d2dc; }
        public static RenderTarget ChainDrawGlyphRun(this RenderTarget d2dc, RawVector2 baselineOrigin,
        ...
        public static RenderTarget ChainDrawLine(this RenderTarget d2dc, RawVector2 point0, RawVector2 point1, Brush brush, float strokeWidth = 1)
        { d2dc.DrawLine(point0, point1, brush, strokeWidth); return d2dc; }
        public static RenderTarget ChainDrawLine(this RenderTarget d2dc, RawVector2 point0, RawVector2 point1, Brush brush, StrokeStyle strokeStyle, float strokeWidth = 1)
        { d2dc.DrawLine(point0, point1, brush, strokeWidth, strokeStyle); return d2dc; }
        public static RenderTarget ChainDrawRectangle(this RenderTarget d2dc, RawRectangleF rect, Brush brush, float strokeWidth = 1)
        { d2dc.DrawRectangle(rect, brush, strokeWidth); return d2dc; }
        public static RenderTarget ChainDrawRectangle(this RenderTarget d2dc, RawRectangleF rect, Brush brush, StrokeStyle strokeStyle, float strokeWidth = 1)
        { d2dc.DrawRectangle(rect, brush, strokeWidth, strokeStyle); return d2dc; }
        public static RenderTarget ChainFillEllipse(this RenderTarget d2dc, Ellipse ellipse, Brush brush) { d2dc.FillEllipse(ellipse, brush); return d2dc; }
        public static RenderTarget ChainFillGeometry(this RenderTarget d2dc, Geometry geometry, Brush brush) { d2dc.FillGeometry(geometry, brush); return d2dc; }
        public static RenderTarget ChainFillMesh(this RenderTarget d2dc, Mesh mesh, Brush brush) { d2dc.FillMesh(mesh, brush); return d2dc; }
        public static RenderTarget ChainFillRectangle(this RenderTarget d2dc, RawRectangleF rect, Brush brush) { d2dc.FillRectangle(rect, brush); return d2dc; }
        public static RenderTarget ChainFillRoundedRect(this RenderTarget d2dc, RoundedRectangle rect, Brush brush) { d2dc.FillRoundedRectangle(rect, brush); return d2dc; }
        public static RenderTarget ChainDrawRoundedRect(this RenderTarget d2dc, RoundedRectangle roundedRect, Brush brush, float strokeWidth = 1)
        { d2dc.DrawRoundedRectangle(roundedRect, brush, strokeWidth); return d2dc; }
        public static RenderTarget ChainDrawRoundedRect(this RenderTarget d2dc, RoundedRectangle roundedRect, Brush brush, StrokeStyle strokeStyle, float strokeWidth = 1)
        { d2dc.DrawRoundedRectangle(roundedRect, brush, strokeWidth, strokeStyle); return d2dc; }
        public static RenderTarget ChainDrawText(this RenderTarget d2dc, string text, TextFormat textFormat, RawRectangleF layoutRect,
        ...
        public static RenderTarget ChainDrawTextLayout(this RenderTarget d2dc, RawVector2 origin,
